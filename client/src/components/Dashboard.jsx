  ...
  <AutoText>Continue</AutoText>
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">
                      <AutoText>Multiplayer Quiz Battle</AutoText>
                    </h3>
                    <p className="text-sm text-gray-600">
                      <AutoText>Challenge friends in real-time quiz battles</AutoText>
                    </p>
                  </div>
                </div>
                <div className="flex space-x-2">
                  <Link 
                    to="/create-room" 
                    className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-3 py-2 rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-300 text-sm"
                  >
                    <AutoText>Create</AutoText>
                  </Link>
                  <Link 
                    to="/join-room" 
                    className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-3 py-2 rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 text-sm"
                  >
